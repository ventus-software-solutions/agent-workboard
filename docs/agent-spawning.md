...
Use this guide when running Agent Workboard with a pool of coding agents. The running board is the source of truth: every agent should read its live instructions before claiming work.
...
Open `http://localhost:8088` and select your project unless the operator explicitly names another project.
